...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    # Left xArm 7
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAKROCJ-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6, 7),
        joint_offsets=(
            1*np.pi/2, 0*np.pi/2, 4*np.pi/2, 1*np.pi/2, 2*np.pi/2, 1*np.pi/2, 4*np.pi/2
        ),
        joint_signs=(1, 1, 1, 1, 1, 1, 1),
        gripper_config=(8, 112.12421875, 70.32421875),
    ),
    # Right xArm 7
    "/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAKRM7P-if00-port0": DynamixelRobotConfig(
        joint_ids=(1, 2, 3, 4, 5, 6, 7),
        joint_offsets=(
            0*np.pi/2, 
            3*np.pi/2, 
